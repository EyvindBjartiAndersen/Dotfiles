...
//#include "/home/vuoto/.cache/wal/colors-wal-dwm.h"
...
static const char *fonts[]               = { "monospace:size=10:dpi=157" };
static const char dmenufont[]            = "monospace:size=10:dpi=157";

static char normfgcolor[]                = "#d5c4a1";
static char normbgcolor[]                = "#282828";
#if !VTCOLORS_PATCH
static char normbordercolor[]            = "#d3d0c8";
...
#if !VTCOLORS_PATCH
static char selbordercolor[]             = "#2d2d2d";
#if FLOAT_BORDER_COLOR_PATCH
...
#if TITLECOLOR_PATCH
static char titlefgcolor[]               = "#282828";
...
static const char *nodes[]  = { "nodes", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_a,          spawn,                  {.v = nodes } },
	{ MODKEY,                       XK_space,          spawn,                  {.v = roficmd } },
	{ MODKEY,     	                XK_t,          spawn,                  {.v = termcmd } },
	{ MODKEY,                       XK_y, 	       spawn,                  {.v = upvol   } },
	{ MODKEY,                       XK_l,          spawn,                  {.v = downvol } },
	...
	{ MODKEY|Mod4Mask|ShiftMask,    XK_e,          inplacerotate,          {.i = +1} },
	{ MODKEY|Mod4Mask|ShiftMask,    XK_u,          inplacerotate,          {.i = -1} },
	#endif // INPLACEROTATE_PATCH
	#if PUSH_PATCH || PUSH_NO_MASTER_PATCH
	{ MODKEY|ControlMask,           XK_e,          pushdown,               {0} },
	{ MODKEY|ControlMask,           XK_u,          pushup,                 {0} },
	...
	{ MODKEY|ControlMask,           XK_n,       tagandviewtoleft,       {0} },
	{ MODKEY|ControlMask,           XK_i,      tagandviewtoright,      {0} },
