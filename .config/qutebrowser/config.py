...
c.colors.completion.fg = ['white', 'black', 'black']
...
## Type: FontFamily
c.fonts.web.family.fixed = 'InputMono NerdFont'
...
## Type: String
# c.hints.border = 'None'
c.hints.border = '2px solid #1e1e1e'
...
## Type: List of Regex
c.hints.next_regexes = ['\\bnæste\\b','\\bnext\\b', '\\bmore\\b', '\\bnewer\\b', '\\b[>→≫]\\b', '\\b(>>|»)\\b', '\\bcontinue\\b']

## Comma-separated list of regular expressions to use for 'prev' links.
## Type: List of Regex
c.hints.prev_regexes = ['\\bforrige\\b','\\bprev(ious)?\\b', '\\bback\\b', '\\bolder\\b', '\\b[<←≪]\\b', '\\b(<<|«)\\b']
...
## Type: Padding
c.statusbar.padding = {'top': 5, 'bottom': 5, 'left': 1, 'right': 1}
...
## Type: Dict
c.url.searchengines = {'DEFAULT': 'http://yubnub.org/parser/parse?command={}'}

## Page(s) to open at the start.
## Type: List of FuzzyUrl, or FuzzyUrl
c.url.start_pages = ['https://about:blank']
...
config.bind('<Space>h', 'hint images')
...
config.bind('<Space>a', 'reload -f')
config.bind('<Ctrl-e>', 'scroll-page 0 0.5')
...
#config.bind('N', 'navigate prev')
#config.bind('I', 'navigate next')
# config.bind('`', 'enter-mode set_mark')
# config.bind('ad', 'download-cancel')
# config.bind('b', 'set-cmd-text -s :quickmark-load')
# config.bind('cd', 'download-clear')
# config.bind('co', 'tab-only')
config.bind('r', 'tab-close')
config.bind('t', 'hint all current')
config.bind('<Space>t', 'hint all tab')
...
config.bind('<Space>l', 'tab-move -')
# config.bind('gr', 'tab-move +')
config.bind('<Space>y', 'tab-move +')
# config.bind('go', 'set-cmd-text :open {url:pretty}')
# config.bind('gt', 'set-cmd-text -s :buffer')
# config.bind('gu', 'navigate up')
# config.bind('i', 'enter-mode insert')
#config.bind('n', 'scroll left')
config.bind('N', 'scroll-px -75 0 ')
config.bind('I', 'scroll-px 75 0 ')
config.bind('e', 'scroll-px 0 75')
config.bind('u', 'scroll-px 0 -75')
config.bind('<Space>e', 'hint links spawn mpv --no-input-default-bindings {hint-url}')
# config.bind('m', 'quickmark-save')
config.bind('o', ':spawn qdmenu')
config.bind('<Space>o', ':spawn qtdmenu')
# config.bind('<Space>o', ':spawn qtdmenu')
...
config.bind('<Space>i', 'hint images download')
config.bind('<Space>b', ':bookmark-add')
...
config.bind('n', 'move-to-prev-word', mode='caret')
...
config.bind('i', 'move-to-next-word', mode='caret')
